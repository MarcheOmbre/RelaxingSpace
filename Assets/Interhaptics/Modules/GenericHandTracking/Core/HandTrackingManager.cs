...
namespace Interhaptics.HandTracking
{
    ...
    public sealed class HandTrackingManager : Utils.Singleton<HandTrackingManager>
    {
        ...
        /// </summary>
        //To comment out to use the old XR System.
        public static UnityEngine.XR.TrackingOriginModeFlags TrackingOriginMode => Tools.HandTrackingSettings.Instance.trackingOriginMode;
        //To uncomment to use the old XR System
        ...
        protected override void OnStart()
        {
            ...
            /*
             * Force room scale.
             * Fix the camera stucked on the ground.
             */

            //To comment out to use the old XR System.
            if (UnityEngine.XR.Management.XRGeneralSettings.Instance && UnityEngine.XR.Management.XRGeneralSettings.Instance.Manager &&
                UnityEngine.XR.Management.XRGeneralSettings.Instance.Manager.activeLoader && UnityEngine.XR.Management.XRGeneralSettings.Instance.Manager.activeLoader)
            {
                ...
                if (subsystem != null)
                {
                    subsystem.TrySetTrackingOriginMode(TrackingOriginMode);
                }
            }
            //To uncomment to use the old XR System
            //UnityEngine.XR.XRDevice.SetTrackingSpaceType(TrackingSpace);
        }
        ...
        private void GetTrackingData()
        {
            ...
            if (canHaveSkeletonMethod != null && (bool) canHaveSkeletonMethod.Invoke(_providerInstanceUsed, null))
            {
                ...
                {
                    //FINGER NORM
                    UnityEngine.Vector2?[] myNorms = new UnityEngine.Vector2?[] { null, null, null, null, null, null };

                    System.Reflection.MethodInfo getGrabNorm =
                                   _providerTypeUsed.GetMethod(Tools.ReflectionNames.GET_GRAB_NORM_PROVIDER_METHOD_NAME);

                    if (getGrabNorm != null)
                        myNorms = (UnityEngine.Vector2?[])getGrabNorm.Invoke(_providerInstanceUsed, null);
                    ...
                    ApplySkeletonTrackingData(trackingData, myNorms);
                    OnTrackingReceived.Invoke(LeftHand);
                    OnTrackingReceived.Invoke(RightHand);
        ...
        {
            //FINGER NORM
            LeftHand.FingerNorms = new UnityEngine.Vector2?[] { null, null, null, null, null, null };
            RightHand.FingerNorms = LeftHand.FingerNorms;
        ...
        private void ApplySkeletonTrackingData(Types.SSkeletonTrackingData trackingData, UnityEngine.Vector2?[] fingerNorms)
        {
            //FINGER NORM
            LeftHand.FingerNorms = fingerNorms;
            RightHand.FingerNorms = LeftHand.FingerNorms;
