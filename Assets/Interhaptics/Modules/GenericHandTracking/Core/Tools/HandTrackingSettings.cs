...
namespace Interhaptics.HandTracking.Tools
{
    ...
    public class HandTrackingSettings : UnityEngine.ScriptableObject
    {
        ...
        public static readonly string MY_ASSET_SETTINGS_PATH = $"Assets/Interhaptics/Modules/GenericHandTracking/Resources/{MY_ASSET_SETTINGS_NAME}.asset";
        #endregion
        ...
        /// </summary>
        [UnityEngine.SerializeField]
        [UnityEngine.Tooltip("Defines the Headset tracking origin point")]
        //To comment out to use the old XR System.
        public UnityEngine.XR.TrackingOriginModeFlags trackingOriginMode = UnityEngine.XR.TrackingOriginModeFlags.Floor;
