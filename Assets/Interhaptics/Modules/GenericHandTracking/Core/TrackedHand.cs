...
namespace Interhaptics.HandTracking
{
    ...
    public class TrackedHand : UnityEngine.MonoBehaviour
    {
        ...
        /// </summary>
        public readonly UnityEngine.Events.UnityEvent AfterHandUpdated = new UnityEngine.Events.UnityEvent();
        ...
        /// <summary>
        /// Get/set the Tracked Hand current Hand Mask.
        /// </summary>
        public Tools.HandMask.MaskPart CurrentHandMask { get; set; } = Tools.HandMask.MaskPart.All;
        /// <summary>
        /// Called when the hands are finished to render.
        /// </summary>
        public UnityEngine.Events.UnityEvent AfterHandRendering = new UnityEngine.Events.UnityEvent();
        #endregion


        #region PRIVATE FIELDS
        private bool _useMeshRenderer = true;
        private Hand _lastHandData = null;
        #endregion
        ...
        {
            // Refreshing authorized bodypart by overriding the pose over the animation
            if (_lastHandData != null && _lastHandData.UseGestures && myHandAnimator)
                AfterHandRendering?.Invoke();
        }
        ...
        private void UpdateTrackingData(Hand handData)
        {
            ...
            if (!useGesture && this.HandObject)
            {
                handData.SetHandSkeleton(this.HandObject, this.CurrentHandMask);
                AfterHandRendering?.Invoke();
            }
