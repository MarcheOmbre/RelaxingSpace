...
namespace Interhaptics.HapticRenderer.Core
{
    public class HARWrapper
    {
        ...
        [DllImport(DLL_NAME)]
        public static extern int GetHmaterialVersionStatus(string _content);
        [DllImport(DLL_NAME)]
        public static extern int GetUpdatedHmaterialV3toV4Size(string _content);
        [DllImport(DLL_NAME)]
        public static extern bool GetUpdatedHmaterialV3toV4(string _content, StringBuilder _updatedVersion);
