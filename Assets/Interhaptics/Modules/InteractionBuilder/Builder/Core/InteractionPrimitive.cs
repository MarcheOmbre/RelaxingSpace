...
namespace Interhaptics.Modules.Interaction_Builder.Core
{
    ...
    public class InteractionPrimitive : ScriptableObject
    {
        ...
        private const bool DEFAULT_SWITCH_ONEHAND = false;
        ...
        [Tooltip("If true, the interaction can switch between one or two hands")]
        public bool oneHandSwitch = DEFAULT_SWITCH_ONEHAND;
