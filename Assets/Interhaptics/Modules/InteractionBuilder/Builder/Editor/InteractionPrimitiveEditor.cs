...
namespace Interhaptics.Modules.Interaction_Builder.Editor
{
    ...
    public class InteractionPrimitiveEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty _myOneHandSwitch;
        ...
        private void OnEnable()
        {
            ...
            _myOneHandSwitch = serializedObject.FindProperty("oneHandSwitch");
        ...
        public override void OnInspectorGUI()
        {
            ...
            BodyPartInteractionStrategy bodyPartInteractionStrategy = (BodyPartInteractionStrategy)_myBodyPartInteractionStrategy.intValue;
            if (bodyPartInteractionStrategy == BodyPartInteractionStrategy.TwoHands || bodyPartInteractionStrategy == BodyPartInteractionStrategy.TwoHandsWithHead)
                EditorGUILayout.PropertyField(_myOneHandSwitch, new GUIContent("One hand switch"));
