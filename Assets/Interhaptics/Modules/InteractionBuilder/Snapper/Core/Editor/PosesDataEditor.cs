...
{
    [CustomEditor(typeof(PosesData))]
    public class PosesDataEditor : UnityEditor.Editor
    {
        #region Constants
        private const string LABEL_NoData = "No data found in this PosesData. You can create data by editing a PosesData through the SnappingPrimitive script";
        ...
        public override void OnInspectorGUI()
        {
            ...
            PosesData posesData = ((PosesData)target);

            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            string[] dataKeys = posesData.posesDictionary.GetDatabaseKeys();
