...
namespace Interhaptics.ObjectSnapper.Editor
{
    ...
    public class SnappingObjectEditor : UnityEditor.Editor
    {
        ...
        private const string TITLE_DebugTracker = "Debug";
        private const string TITLE_SubscribedSnappingPrimitives = "Subscribed SnappingPrimitives";
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (Application.isPlaying)
            {
                ...
                if (snappingObject)
                {
                    ...
                    {
                        SnappingPrimitive[] subscribedSnappingPrimitives = snappingObject.SubscribedPrimitives;
                    ...
                    {
                        EditorGUILayout.Space();
                        ASnappableActor[] subscribedASnappableActor = snappingObject.SubscribedRuntimeActors;
